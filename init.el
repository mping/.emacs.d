...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (diredful tagedit smex rainbow-delimiters projectile paredit magit ido-ubiquitous flycheck-tip flycheck-pos-tip exec-path-from-shell edts dired-details+ company-distel company clojure-mode-extra-font-locking cider anchored-transpose)))
